...
variable "aws_region" {
  description = "Region holding the state bucket and lock table. Clinical audio and its transcripts stay in the EU, so the state that describes them does too."
  type        = string
  default     = "eu-west-1"
