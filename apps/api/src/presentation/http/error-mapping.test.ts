...
describe('toErrorResponse', () => {
  ...
  it('recognises a domain error by its code alone, with no class and no name', () => {
    ...
    // `name` may be a single letter and `instanceof` may be comparing against
    // a different copy of the constructor. Only `code` survives that, and
    // this bare object proves the mapper needs nothing else.
