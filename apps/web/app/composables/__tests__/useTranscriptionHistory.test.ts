...
describe('useTranscriptionHistory', () => {
  ...
  // A second press in flight would advance the trail twice, skipping a page.
  ...
  /*
   * The proxy refreshes an expired access token before a 401 could reach here,
   * so one that does means signing in again rather than retrying.
   */
