...
describe('AlertBanner', () => {
  ...
  /*
   * role="alert" carries an implicit aria-live="assertive", which interrupts
   * whatever a screen reader is saying. Spending that on "sesión iniciada"
   * teaches the user to tune out the announcement that had to be heard.
   */
  it.each([
    ['info', 'status'],
    ['success', 'status'],
