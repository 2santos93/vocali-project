...
describe('TranscriptionHistoryTable', () => {
  ...
  // A zero would read as silent audio in an empty file.
  ...
  /*
   * The signed URL is short-lived and asked for on press: a link rendered with
   * the page carries a URL expired by the time most users reach it.
   */
  ...
  // Blanking the list to load the next page throws away what was being read.
