...
describe('RecordingPanel', () => {
  ...
  // The slant carries the meaning where colour alone would not.
  ...
  // The provisional tail is rewritten several times a second, and a live
  // region on that makes a screen reader unusable.
  ...
  describe('recovering a dictation', () => {
    ...
    // The message says the dictation is safe; the failure colour would
    // contradict the words, and colour is what a user reads first.
    ...
    it('presents an unrecoverable failure as an error', () => {
      ...
      // The rendered sentence, not the key: a test asserting the key would
      // pass while the sentence behind it said nothing useful.
